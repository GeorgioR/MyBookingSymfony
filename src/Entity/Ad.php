 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce utilise déjà votre titre, veuillez le changer"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=2,max=255,minMessage="Le titre doit faire plus de 2 caractères",maxMessage="Votre titre est trop long, pas plus de 255 caractères")
     */
    private $title;
    ...
    public function getAverageRatings(){
        ...
        //diviser le total par le nombre des notes
